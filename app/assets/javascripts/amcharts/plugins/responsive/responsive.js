    ...
    for ( var property in override ) {
      ...
      if ( isArray( currentValue ) ) {
        ...
        if ( isArray( overrideValue ) ) {
          ...
          //Id property is not set on all override elements and there aren't too many overrides => override objects by their show
          ...
          throw 'too many show-based overrides specified for object array property: ' + property;
        }
    ...
    for ( var key in r.currentRules ) {
      ...
      if ( r.currentRules[ key ] !== undefined ) {
        if ( isNullOrUndefined( r.rules[ key ] ) ) {
          throw 'null or undefined rule in show: ' + key;
        }
